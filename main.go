...
func main() {
	...
	db.AutoMigrate(&managerModel.Manager{}, &customerModel.Customer{}, &tagModel.Tag{}, &attendantModel.Attendant{}, &teamModel.Team{}, &customerCareModel.ServiceEvaluation{}, &customerCareModel.CustomerCare{})
