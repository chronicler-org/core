...
type ServiceEvaluation struct {
	...
	CustomerCareID uuid.UUID              `gorm:"column:customer_care_id;not null" json:"-"`
	CustomerCare   CustomerCare           `gorm:"foreignKey:CustomerCareID;not null" json:"customer_care"`
