...
type AttendantEvaluation struct {
	...
	AvaluatedID uuid.UUID `gorm:"type:uuid;column:avaluated_id;unique;not null" json:"-"`
	Avaluated   Attendant `gorm:"foreignKey:AvaluatedID" json:"avaluated"`
	AvaluatorID uuid.UUID `gorm:"type:uuid;column:avaluator_id;unique;not null" json:"-"`
